...
Платформа для изучения программирования: каталог курсов, последовательная разблокировка уроков, видео с YouTube и теория на Markdown, серверная проверка тестов, прогресс, опыт (XP) и серия активных дней (streak).
...
| Администратор | + CRUD курсов, уроков (включая видео с YouTube), вопросов, статистика по студентам |
...
| **Урок** — теория на Markdown с подсветкой кода, тест внизу | **Видео в уроке** — YouTube-плейер над теорией, если админ добавил ссылку |
| ![](docs/screenshots/03-lesson.png) | ![](docs/screenshots/09-lesson-video.png) |
| **Результат попытки** — по вопросам, без утечки правильных ответов до сдачи | **Профиль** — опыт, серия дней, прогресс по курсам |
| ![](docs/screenshots/04-attempt-result.png) | ![](docs/screenshots/05-profile.png) |
| **Рейтинг** — за неделю и за всё время | **Админка** — список курсов |
| ![](docs/screenshots/06-leaderboard.png) | ![](docs/screenshots/07-admin-courses.png) |
| **Админка** — редактирование курса, уроки, живая статистика | |
| ![](docs/screenshots/08-admin-course-detail.png) | |
